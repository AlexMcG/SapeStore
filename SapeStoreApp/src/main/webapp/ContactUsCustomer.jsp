...
<!-- 					</div> -->
						...
						<section>
							...
							<div id="tabbed">
								<ul class="nav nav-tabs">
									<li class=""><a href="/SapeStore/policyCustomer">Privacy
											Policy</a></li>
									<li class="active"><a href="/SapeStore/contactUsCustomer">Contact Us Page</a></li>
								</ul>
										...
										<div id="div1"
											...
											<form:form action="/SapeStore/admin/contactUs">
												...
												<textarea id="contactText" name="contactText"
													rows="20"
													style="/*width: 925px; margin-left: 20px; height: 755px*/">${contactUsText}</textarea>
											</form:form>
										</div>
									</div>
								</div>
	...
	<script src="/SapeStore/js/contactUs.js"></script>
